...
function createOrder() {
  ...
  const delete_cart = createTag(order_section, "button", "delete_cart", "cart_btns", "Delete Cart");
  const checkout = createTag(order_section, "button", "checkout", "cart_btns", "Checkout");
...
function createFooter() {
  const footer_section = createTag(null, "footer")
  createTag(footer_section, "p", "copyright", null, "&copy Moonbucks");
  let social_list = ["<i class='fa-brands fa-facebook-f'></i>", "<i class='fa-brands fa-instagram'></i>", "<i class='fa-brands fa-twitter'></i>"];
  createMultiTags(footer_section, "a", social_list.length, social_list, true);
  // add space the logo
